...
import { SOLANA_USDC_ADDRESS, decodeEventNonceFromMessage, getAnchorConnection, getMessages, getPrograms, getReceiveMessagePdas } from './utils';

const main = async () => {
    const provider = await getAnchorConnection();
